        ...
        try:
            ...
            try:
                if demodata:
                    ...
                    query = f"SELECT i.inspection_id, i.start_date, c.name  from inspections i, customer c  where i.customer_id = c.customer_id  AND inspector_id = {userid} and week_starting = '{start}';"
